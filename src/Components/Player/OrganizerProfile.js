...
// // import React from "react";  //onClick={() => navigate("/OrganizerMyProfile", { state: { id } })}
// import { HashLink } from "react-router-hash-link";
// import { useSelector, useDispatch } from "react-redux";
// import { useEffect, useState } from "react";
// import { useNavigate, useParams, useLocation } from "react-router-dom";
...
//   const organizer = useSelector((state) => state.User.user);
...
//               }}
//               onClick={() => {
//                 console.log("Navigating to OrganizerMyProfile with player:", player); // Log the player data
...
//                     setSelectedOrganizerId(id); // Update state or perform any logic
//                    navigate("/OrganizerMyProfile", { state: { id } }); // Navigate with state
//                   }}
